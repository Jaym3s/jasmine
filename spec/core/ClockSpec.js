...
//    it("should be possible to install/uninstall the clock", function() {
//      var setTimeout = jasmine.createSpy('setTimeout'),
//      global = { setTimeout: setTimeout},
//      env = new jasmine.Env(global),
//      env.it(function() {
//             setTimeout()
//          });
//    });
...
//    })
//  });
// should allow for settimeout fns to be eval'd
// should allow for params pas
